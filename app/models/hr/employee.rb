...
class Employee < ActiveRecord::Base
  ...
  def create_user_and_validate
    self.email ||="noreply" + self.employee_number.to_s + "@adequate.com"
    if self.new_record?
      ...
      user_record.email = self.email.blank? ? "noreply#{self.employee_number.to_s}@adequate.com" : self.email.to_s
	  ...
	  if self.employee_number.to_s == 'admin' or self.employee_number.to_s =='superadmin'
